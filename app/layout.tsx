...
export const metadata: Metadata = {
  title: {
    default: "FumigationKenya | Termite Control & Pest Management in Kenya",
    template: "%s | FumigationKenya",
  },
  ...
  authors: [{ name: "FumigationKenya" }],
  creator: "FumigationKenya",
  ...
  openGraph: {
    ...
    siteName: "FumigationKenya",
    title: "FumigationKenya | Termite Control & Pest Management in Kenya",
    description: "Kenya's trusted termite control and pest management specialists. Expert fumigation services across Kenya.",
  },
  twitter: {
    card: "summary_large_image",
    title: "FumigationKenya | Termite Control & Pest Management",
